...
# Functions that return Herr, pass back nothing to Julia (as an output), with simple error messages
...
# Functions returning a single argument, and/or with more complex error messages
