...
@bind h5p_get_filter_by_id(plist_id::hid_t, filter_id::Cint, flags::Ref{Cuint}, cd_nelmts::Ref{Csize_t}, cd_values::Ptr{Cuint}, namelen::Csize_t, name::Ptr{UInt8}, filter_config::Ptr{Cuint})::herr_t "Error getting filter ID"
...
@bind h5p_modify_filter(plist_id::hid_t, filter_id::Cint, flags::Cuint, cd_nelmts::Csize_t, cd_values::Ptr{Cuint})::herr_t "Error modifying filter"
...
@bind h5p_set_filter(plist_id::hid_t, filter_id::Cint, flags::Cuint, cd_nelmts::Csize_t, cd_values::Ptr{Cuint})::herr_t "Error setting filter"
