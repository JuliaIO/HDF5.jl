...
"""
To refresh hdf5.tag, download it from `"\$(DEFAULT_URL_PREFIX)hdf5.tag"`
(HDF Group's continuously-updated tag file for the latest HDF5 docs) and
overwrite `joinpath(dirname(@__DIR__), "hdf5.tag")`, i.e. `HDF5_TAG_URL` below.
"""
